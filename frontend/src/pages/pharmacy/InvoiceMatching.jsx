  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          {onBack && (
            <button onClick={onBack} className="inline-flex items-center text-xs font-semibold text-slate-600 hover:underline mb-2 gap-1">
              <ArrowLeft className="w-3.5 h-3.5" /> Back to Suppliers
            </button>
          )}
          <h2 className="text-xl font-bold text-slate-800">Invoice Matching</h2>
          <p className="text-sm text-slate-500 mt-1">Match supplier invoices to GRNs and verify amounts.</p>
        </div>
