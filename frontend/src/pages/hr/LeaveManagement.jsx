  ...
  return (
    <div style={{ padding: '24px', maxWidth: '1000px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 700, color: 'var(--color-text)', marginBottom: '20px', display: 'flex', alignItems: 'center', gap: '8px' }}>
        <CalendarX size={24} color="#be185d" /> Leave Requests Management
      </h1>
          ...
          <tbody>
            {sampleLeaves.map(l => (
              <tr key={l.id} style={{ borderBottom: '1px solid var(--color-surface-alt)' }}>
                ...
                <td style={{ padding: '12px 16px', fontSize: '0.8rem', color: 'var(--color-text-muted)' }}>{l.startDate} to {l.endDate} ({l.days}d)</td>
