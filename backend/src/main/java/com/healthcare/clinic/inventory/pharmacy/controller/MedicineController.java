...
import com.healthcare.clinic.inventory.pharmacy.mapper.MedicineMapper;
import com.healthcare.clinic.inventory.entity.StockAdjustment;
import com.healthcare.clinic.inventory.entity.PurchaseOrder;
import com.healthcare.clinic.inventory.entity.PurchaseOrderItem;
import com.healthcare.clinic.inventory.pharmacy.repository.StockAdjustmentRepository;
import com.healthcare.clinic.inventory.pharmacy.repository.PurchaseOrderRepository;
...
public class MedicineController {
    ...
    private final com.healthcare.clinic.inventory.repository.PharmacyUserRepository userRepository;
    ...
    public MedicineController(MedicineRepository medicineRepository, 
                              ...
                              com.healthcare.clinic.inventory.repository.PharmacyUserRepository userRepository,
    ...
    public ResponseEntity<ApiResponse<StockAdjustment>> adjustStock(@Valid @RequestBody StockAdjustment adjustment) {
        ...
        com.healthcare.clinic.inventory.entity.PharmacyUser user = userRepository.findByUsername(username)
    ...
    public ResponseEntity<ApiResponse<String>> autoGeneratePOs() {
        ...
        for (Medicine med : medicines) {
            ...
            if (med.getReorderLevel() != null && currentStock <= med.getReorderLevel()) {
                ...
                com.healthcare.clinic.inventory.entity.Supplier supplier = null;
                ...
                if (supplier != null) {
                    final com.healthcare.clinic.inventory.entity.Supplier finalSupplier = supplier;
