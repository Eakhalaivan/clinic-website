...
import com.healthcare.clinic.inventory.entity.PharmacyInsuranceClaim;
import com.healthcare.clinic.inventory.entity.PharmacyInsuranceClaimLineItem;
import com.healthcare.clinic.inventory.entity.InsuranceProvider;
import com.healthcare.clinic.inventory.pharmacy.repository.PharmacyInsuranceClaimRepository;
import com.healthcare.clinic.inventory.pharmacy.repository.InsuranceProviderRepository;
        ...
        try {
            ...
            if (auth != null && auth.isAuthenticated() && !(auth instanceof org.springframework.security.authentication.AnonymousAuthenticationToken)) {
                ...
                return userRepository.findByUsername(username)
                        .map(com.healthcare.clinic.inventory.entity.PharmacyUser::getId)
                        .orElse(1L);
            }
        } catch (Exception e) {
