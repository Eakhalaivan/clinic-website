...
public class AnalyticsController {
    ...
    public ResponseEntity<ApiResponse<java.util.List<com.healthcare.clinic.pharmacy.dto.analytics.ABCAnalysisDTO>>> getAbcAnalysis(
        ...
        java.util.List<com.healthcare.clinic.pharmacy.dto.analytics.ABCAnalysisDTO> data = analyticsService.getAbcAnalysis(startDate, endDate);
    ...
    public ResponseEntity<ApiResponse<com.healthcare.clinic.pharmacy.dto.analytics.MonthOverMonthDTO>> getMonthOverMonthComparison(
        ...
        com.healthcare.clinic.pharmacy.dto.analytics.MonthOverMonthDTO data = analyticsService.getMonthOverMonthComparison(monthAStart, monthAEnd, monthBStart, monthBEnd);
    ...
    public ResponseEntity<ApiResponse<com.healthcare.clinic.pharmacy.dto.analytics.StockMovementInsightsDTO>> getStockMovementInsights(
        ...
        java.util.List<com.healthcare.clinic.pharmacy.dto.analytics.MedicineStatsDTO> topMoving = analyticsService.getFastMovingMedicines(startDate, endDate, limit);
        java.util.List<com.healthcare.clinic.pharmacy.dto.analytics.MedicineStatsDTO> topNonMoving = analyticsService.getSlowMovingMedicines(startDate, endDate, limit);
        
        dto.setTopMoving(topMoving);
        dto.setTopNonMoving(topNonMoving);
        
        java.math.BigDecimal movingVal = topMoving.stream()
                .map(com.healthcare.clinic.pharmacy.dto.analytics.MedicineStatsDTO::getStockValueLocked)
