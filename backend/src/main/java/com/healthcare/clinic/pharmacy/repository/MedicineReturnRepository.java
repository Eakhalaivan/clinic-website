...
import com.healthcare.clinic.pharmacy.model.MedicineReturn;
...
public interface MedicineReturnRepository extends JpaRepository<MedicineReturn, Long> {
    ...
    long countByStatus(com.healthcare.clinic.pharmacy.enums.ReturnStatus status);
    ...
    java.math.BigDecimal sumTotalReturnAmountByDateAndStatus(@org.springframework.data.repository.query.Param("start") LocalDateTime start, 
                                                             ...
                                                             @org.springframework.data.repository.query.Param("status") com.healthcare.clinic.pharmacy.enums.ReturnStatus status);
}
