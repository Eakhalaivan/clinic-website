...
(1, 101, 'Sunita Sharma', '04', 'Paracetamol 500mg', '1 Tab', CURRENT_TIMESTAMP - INTERVAL '2 HOURS', 'GIVEN', 1),
...
(3, 104, 'Ananya Patel', '08', 'Pantoprazole 40mg IV', '1 Vial', CURRENT_TIMESTAMP - INTERVAL '3 HOURS', 'GIVEN', 1);
